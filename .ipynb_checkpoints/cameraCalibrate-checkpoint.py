...
square_size = 0.030 # Size, in meters, of a square side 
...
def main():
  ...
  cv_file = cv2.FileStorage('calibration_chessboardDrone.yaml', cv2.FILE_STORAGE_WRITE)
  cv_file.write('K', mtx)
  cv_file.write('D', dist)
  cv_file.release()
  
  # Load the parameters from the saved file
  cv_file = cv2.FileStorage('calibration_chessboardDrone.yaml', cv2.FILE_STORAGE_READ) 
